package it.units.erallab.evolution.validation;
...
public class RobotsTerrainsValidation extends Worker {

  public static void main(String[] args) {
    new RobotsTerrainsValidation(args);
  }

  public RobotsTerrainsValidation(String[] args) {
    super(args);
  }
